...
# This file is kept for backward compatibility and to provide a single entry point for running all tests.
# """

# # Import all test modules to ensure they are discovered by pytest
# from backend.tests import test_auth
# from backend.tests import test_user
# from backend.tests import test_utils

# # The actual test fixtures and setup are in conftest.py
# # This file is mainly for importing all test modules
